...
//#region node_modules/.nitro/vite/services/ssr/assets/router-Ccg9Eifa.js
var router_Ccg9Eifa_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-BilkFcKG.css";
var APP_NAME = "MentalMath Pro";
var APP_DESCRIPTION = "Mental math trainer for percentages, multiplication, division, and addition. Optional timer and a 5-question challenge.";
var INLINE_FAVICON = "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32'%3E%3Crect width='32' height='32' rx='8' fill='%231f5f5b'/%3E%3Ccircle cx='10.5' cy='10.5' r='3.1' fill='%23f3efe6'/%3E%3Ccircle cx='21.5' cy='21.5' r='3.1' fill='%23f3efe6'/%3E%3Cpath d='M20.8 7.2c.7-.5 1.6-.3 2.1.4.5.7.3 1.6-.4 2.1L11.2 24.8c-.7.5-1.6.3-2.1-.4-.5-.7-.3-1.6.4-2.1L20.8 7.2z' fill='%23f3efe6'/%3E%3C/svg%3E";
var THEME_BOOT = `(function(){try{var t=localStorage.getItem('mentalmath-theme');if(t==='dark'||(t!=='light'&&window.matchMedia('(prefers-color-scheme: dark)').matches))document.documentElement.classList.add('dark');}catch(e){}})();`;
...
var $$splitComponentImporter = () => import("./routes-C_wfem0a.mjs");
...
//#endregion
export { getRouter, router_Ccg9Eifa_exports as t };
